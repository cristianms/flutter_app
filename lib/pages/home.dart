...
class Home extends StatelessWidget {
  ...
  var arrFrases = [
    "o padrão tranca a inovação",
    "é isso que eu digo...",
    "é isso que me irrita...",
    "olha, por favor!",
    "eles não sabem o que é cloud!",
    "eles são muito burro!",
    "eu tava vendo umas coisas em GO...",
    "Blá blá blá...... começa por aí",
    "Dijon... dijon",
    "... é uma porcaria!",
    "a gente pode fazer uma receitinha Docker",
  ];
